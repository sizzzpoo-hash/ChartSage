...
3.  **Execution Timeframe Technical Analysis:**
    *   Now, perform a detailed technical analysis of the main chart image and its corresponding \`{{interval}}\` OHLCV data. Your analysis MUST incorporate:
        ...
        *   **Contradictory Signal Check:** Actively look for signals that contradict your primary thesis. If the primary trend is bullish, are there any bearish reversal patterns forming? Are there bearish divergences on any indicators? These contradictions must be noted in your analysis and considered in your SWOT.
